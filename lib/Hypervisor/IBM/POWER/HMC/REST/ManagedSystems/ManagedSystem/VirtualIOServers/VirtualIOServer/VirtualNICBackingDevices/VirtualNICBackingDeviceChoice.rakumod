...
has     Hypervisor::IBM::POWER::HMC::REST::ManagedSystems::ManagedSystem::VirtualIOServers::VirtualIOServer::VirtualNICBackingDevices::VirtualNICBackingDeviceChoice::VirtualNICSRIOVBackingDevice  $.VirtualNICSRIOVBackingDevice  is conditional-initialization-attribute;
...
method init () {
    ...
    if self.attribute-is-accessed(self.^name, 'VirtualNICSRIOVBackingDevice') {
