...
method load () {
    ...
    $!LogicalPartitionAssignmentCapable     = self.etl-text(:TAG<LogicalPartitionAssignmentCapable>,    :$!xml);
    $!DynamicPartitionAssignmentCapable     = self.etl-text(:TAG<DynamicPartitionAssignmentCapable>,    :$!xml);
    $!xml                                   = Nil;
    $!loaded                                = True;
    self;
}
